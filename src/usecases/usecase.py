...
#
#     def act(self, city: str, days: int, language: str) -> None:
#         geolocation = GeolocationClient(
#             url=self.settings.geolocation_url,
#             timeout=self.settings.timeout,
#         )
#         weather_forecast = WeatherClient(
#             url=self.settings.weather_url, timeout=self.settings.timeout
#         )
#         if days == 1:
#             weather_forecast.get_current_weather(
#                 geolocation=geolocation.get_geolocation(city_name=city, language=language),
#             )
#         else:
